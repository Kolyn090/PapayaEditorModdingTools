...
namespace ModdingTool.Assets.Editor.AssignSpritesToAtlas
{
    public class AssignSpritesToAtlasMain : EditorWindow
    {
        ...
        {
            GetWindow<AssignSpritesToAtlasMain>("Assign Sprites To Atlas");
        }
